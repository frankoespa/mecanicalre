...
class About extends Component {
    ...
    componentDidMount() {
        ...
        window.kissuiScrollAnim.add(this.frase4, {
            'in': 'fadeIn'
        });
    ...
    render() {
        return (
            <div className="container center-align app-section scrollspy" id="nosotros">
                ...
                <p className="flow-text grey-text text-darken-3 app-desc" ref={(frase4) => { this.frase4 = frase4 }}>Nuestro personal se encuentra siempre en constante capacitación, manteniéndose completamente actualizados sobre las últimas técnicas y procesos de reparaciones y diagnósticos</p>
